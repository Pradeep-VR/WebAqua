    ...
    <div class="main-content-inner" id="divEntry" runat="server">
        <div class="page-content">
            <asp:UpdatePanel ID="upQualityEntry" runat="server">
                <ContentTemplate>
                    <h4 class="header green">Packing Module - IQF</h4>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card-body" style="border: groove">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <%--<div class="col-md-1">
                                        <div class="mb-2 row">
                                            <label for="fname">BatchNo</label>
                                            <asp:TextBox ID="TextBox1" runat="server" MaxLength="10" Enabled="false" CssClass="form-control border border-success" />
                                        </div>
                                    </div>--%>  
                                    <div class="col-md-2">
                                        <div class="mb-2 row">
